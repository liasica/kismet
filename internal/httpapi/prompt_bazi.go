...
// baziAdultSections 成人的章节清单，两个 %s 依次为当前与下一个流年
const baziAdultSections = `请按下面的章节批命，总篇幅 2500 到 3500 字：
## 命局总论
...
// baziMinorSections 未成年人的章节清单，两个 %s 依次为当前与下一个流年
const baziMinorSections = `命主是未成年人，批命对象是其父母，不谈婚姻、财运与事业。请按下面的章节批命，总篇幅 1800 到 2500 字：
## 命局总论
